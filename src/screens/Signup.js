...
export default function Signup() {
  ...
  const handleClick = async (e) => {
    ...
    const response = await fetch("https://crunchy-backend-qznpzy06p-1siikaa.vercel.app/getlocation", {
      method: 'POST',
      headers: {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch("https://crunchy-backend-qznpzy06p-1siikaa.vercel.app/createuser", {
      // credentials: 'include',
